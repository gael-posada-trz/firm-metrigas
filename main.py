...
def run_ble_pairing_server():
    ...
    CHARACTERISTIC_UUID = bluetooth.UUID("0000FFF1-0000-1000-8000-00805F9B34FB")
    
    WRITE_PROPERTY = bluetooth.FLAG_WRITE
    ...
    if boot.check_and_connect_wifi(ble_context["ssid"], ble_context["password"], timeout=12000):
        ...
        ble.active(False)
        return run_ble_pairing_server() # Safety recursive retry
...
while True:
    # Your sensor, MQTT, actuator code, etc. goes here.
